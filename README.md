...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/andymanitara/dodgeball-blitz-pocket-arena-3)
...
2.  Deploy the project:
    ...
    bun run deploy
    ```
### Advanced Deployment & Matchmaking
For instructions on enabling the server-side matchmaking queue using Cloudflare Durable Objects, please refer to the [Deployment Guide](DEPLOYMENT.md).
## License
